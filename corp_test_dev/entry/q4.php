...
<body onload="getFormsCnt()">
	...
	<form style="display:none">
		<div class="contents">
			...
			<div class="answer">
				<table class="gijutsu">
				<td><input type="radio" name="q1" id="a1" value="TRUE" checked="checked"></td><td><label onclick="" for="a1">オブジェクトが相互にメッセージを送ることによって、協調して動作し、プログラム全体の機能を実現する。</label></td></tr>
			...
			<div class="answer">
				<table class="gijutsu">
				<tr><td><input type="radio" name="q7" id="gg1" value="TRUE"></td><td><label onclick="" for="gg1">テスト項目の消化件数</label></td></tr><tr>
				<td><input type="radio" name="q7" id="gg2" value="FALSE"></td><td><label onclick="" for="gg2">テストデータの作成量</label><br></tr><tr>
				<td><input type="radio" name="q7" id="gg3" value="FALSE"></td><td><label onclick="" for="gg3">プログラムの起動回数</label><br></tr><tr>
				<td><input type="radio" name="q7" id="gg4" value="FALSE"></td><td><label onclick="" for="gg4">プログラムの修正量</label></td></tr>
