...
<body onload="getFormsCnt()">
	...
	<!--トップページ===================================================================== -->
	<form action="menu.php" name="form1" >
		<div class="contents">	
			<p>
			受講者の氏名を入力してください。
			</p>
			<p>
				[苗字]<input type="text" id="LastName" name="LastName" required value="">[名前]<input type="text" id="FirstName" name="FirstName" required value="">
			</p>
